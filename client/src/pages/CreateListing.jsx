        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='mt-5 flex flex-row justify-between'>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="sale" className='w-8'/>
                        <span>Sell</span>
                    </div>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="rent" className='w-8'/>
                        <span>Rent</span>
                    </div>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="parking" className='w-8'/>
                        <span>Parking Spot</span>
                    </div>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="Furnished" className='w-8'/>
                        <span>Furnished</span>
                    </div>
                    <div className='flex gap-2'>
                        <input type="checkbox" id="Offer" className='w-8'/>
                        <span>Offer</span>
                    </div>
                </div>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <div className='flex gap-4'>
                    ...
                    rounded uppercase hover:shadow-xl disabled:opacity-80'>Upload</button>
                </div>
            <button className='p-3 bg-slate-700 text-white rounded-lg 
            uppercase hover:bg-blue-900 disabled:opacity-80'>Create Listing</button>
            </div>
        </form>
    </main>
  )
